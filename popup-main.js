document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('fetchFields').addEventListener('click', () => {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            // Load saved shortcuts or set default
            ...
            // Apply saved shortcuts to input fields in the popup (if you have a settings page/modal)
            ...
            // Save shortcuts when users update them
