(function() {
        ...
        require(['N/record', 'N/https'], function(record, https) {
            try {
                ...
                const salesforceResponse = https.post({
                    ...
                    headers: {
                        'Authorization': 'Bearer 00D5g00000LNAsc!AR0AQDdWQB60P9OZggI.VChhUXlXOyohIG5lODxMYX.ijsR7h3zNG5vpK7ToTKDvmwIUx_BbjU41ueNXTDwifgzRJ5Xk_wLm',
    ...
    // Function to open a new window and display the results
    function openResultsInNewWindow(fieldValues) {
        ...
        ['Field ID', 'Field Value'].forEach(header => {
